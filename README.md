# Портфолио Ольги Степченко · StepAI

Персональный сайт-портфолио специалиста по искусственному интеллекту, цифровым решениям и вайб-кодингу.
...
3. Создайте репозиторий на [GitHub](https://github.com/new) (имя: `stepai-portfolio`)
